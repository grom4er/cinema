package drive_in_cinema.config;

import drive_in_cinema.service.impl.CustomUserDetailService;
...
public class SecureConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/drivers/**").access("hasAuthority('ADMIN')")
                .antMatchers(HttpMethod.POST,
                        "/movies/**",
                        "/movie-sessions/**",
                        "/locations/**").access("hasAuthority('ADMIN')")
                .antMatchers("/orders/**",
                        "/shopping-carts/**").access("hasAuthority('DRIVER')")
